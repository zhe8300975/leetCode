...
// 
//
// Related Topics 数组 动态规划 回溯 👍 1903 👎 0


fun main() {
    TargetSum.Solution().findTargetSumWays(intArrayOf(1, 1, 1, 1, 1), 3)
}
...
class TargetSum {
    ...
    class Solution {
        ...
        fun findTargetSumWays(nums: IntArray, index: Int, target: Int): Int {
            if (index == nums.size) {
