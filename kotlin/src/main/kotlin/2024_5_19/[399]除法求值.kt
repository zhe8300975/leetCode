...
// 
//
// Related Topics 深度优先搜索 广度优先搜索 并查集 图 数组 最短路 👍 1093 👎 0
...
fun main() {
    ...
    var value= doubleArrayOf(2.0,3.0)
    ...
    EvaluateDivision.Solution().calcEquation(equations,value,queries)
}
